...
<html>
    ...
    window.runCode = function () {
      ...
      setTimeout(() => {
        try {
          ...
          logContainer.innerHTML += "<span style='color:red'><b>Runtime Error:</b> " + error.message + "</span><br>";
        }
      }, 100);
    };
    ...
    window.clearConsole = function () {
      document.getElementById("console-output").innerHTML = "Press 'Run' to see any console output";
    };
  });
